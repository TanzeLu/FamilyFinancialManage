...
public class Calender extends JButton {
 private DateChooser dateChooser = null;
 private String preLabel = "";
 public Calender() {
  this(getNowDate());
 }
 public Calender(SimpleDateFormat df, String dateString) {
  this();
 ...
 public Calender(String preLabel, Date date) {
  if (preLabel != null)
 ...
 private class DateChooser extends JPanel implements ActionListener,
  ...
  void showDateChooser(Point position) {
   Frame owner = (Frame) SwingUtilities
     .getWindowAncestor(Calender.this);
